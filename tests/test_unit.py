...
def mock_session(monkeypatch):
    """Fixture providing mocked requests.post"""
    mock = MagicMock()
...
class TestWalletAPIUnit:
    ...
    def test_get_wallet_balance_includes_asset(self, api, mock_session):
        ...
        result = api.get_wallet_balance(blockchain="MainNet", address="0xtest", asset="CIRX")
    ...
    def test_get_wallet_nonce_returns_number(self, api, mock_session):
        ...
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"Result": 200, "Response": {"Nonce": 42}}
        mock_session.return_value = mock_response
...
class TestTransactionAPIUnit:
    ...
    def test_get_pending_transaction(self, api, mock_session):
        ...
        result = api.get_pending_transaction(blockchain="MainNet", transaction_id="0xtx")
    ...
    def test_get_transaction_by_id(self, api, mock_session):
        ...
        result = api.get_transaction_by_id(
            blockchain="MainNet", transaction_id="0xtx", start="100", end="200"
        )
...
class TestBlockAPIUnit:
    ...
    def test_get_block_range(self, api, mock_session):
        ...
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"Result": 200, "Response": {"Blocks": []}}
        mock_session.return_value = mock_response

        result = api.get_block_range(blockchain="MainNet", start="100", end="200")
    ...
    def test_get_block_count(self, api, mock_session):
        ...
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"Result": 200, "Response": {"BlockCount": 999999}}
        mock_session.return_value = mock_response
    ...
    def test_get_analytics(self, api, mock_session):
        ...
        mock_response.json.return_value = {
            "Result": 200,
            "Response": {"TotalTransactions": 1000000, "TotalWallets": 50000, "BlockHeight": 99999},
        }
        mock_session.return_value = mock_response
...
class TestAssetAPIUnit:
    ...
    def test_get_asset_list(self, api, mock_session):
        ...
        mock_response = Mock()
        mock_response.ok = True
        mock_response.json.return_value = {"Result": 200, "Response": {"Assets": ["CIRX", "TEST"]}}
        mock_session.return_value = mock_response
    ...
    def test_get_asset(self, api, mock_session):
        ...
        mock_response.json.return_value = {
            "Result": 200,
            "Response": {"AssetName": "CIRX", "TotalSupply": 1000000000, "Decimals": 8},
        }
        mock_session.return_value = mock_response
    ...
    def test_get_asset_supply(self, api, mock_session):
        ...
        mock_response.json.return_value = {
            "Result": 200,
            "Response": {"TotalSupply": 1000000000, "CirculatingSupply": 750000000},
        }
        mock_session.return_value = mock_response
